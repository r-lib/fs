...
void dir_map(Function fun, const char* path, bool all, int file_type,
              bool recurse, CollectorList* value) {
  uv_fs_t req;
...
// [[Rcpp::export]]
List dir_map_(CharacterVector path, Function fun, bool all, IntegerVector type,
               bool recurse) {
