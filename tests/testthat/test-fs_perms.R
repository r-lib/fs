if (!is_windows()) {
  describe("as_fs_perms (POSIX)", {
    ...
    it("coerces octmode", {
      ...
      expect_equal(
        as_fs_perms(as.octmode(c("644", "777"))),
        new_fs_perms(c(420L, 511L))
      )
    })
    ...
    it("coerces characters in symbolic notation", {
      ...
      expect_equal(
        as_fs_perms(c("rw-r--r--", "rwxrwxrwx")),
        new_fs_perms(c(420L, 511L))
      )
    })
  ...
  describe("as_fs_perms (Windows)", {
    ...
    it("coerces octmode", {
      ...
      expect_equal(
        as_fs_perms(as.octmode(c("600", "700"))),
        new_fs_perms(c(384L, 448L))
      )
      expect_equal(
        as_fs_perms(as.octmode(c("666", "777"))),
        new_fs_perms(c(438L, 511L))
      )
    })
    it("coerces characters in octal notation", {
