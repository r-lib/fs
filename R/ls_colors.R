...
# LS mappings are from https://github.com/wertarbyte/coreutils/blob/f70c7b785b93dd436788d34827b209453157a6f2/src/dircolors.c#L60-L75
# Not all of these are used in this package however.
gnu_ls_code_map <- c(
  "no" = "NORMAL",
  "fi" = "FILE",
  "rs" = "RESET",
