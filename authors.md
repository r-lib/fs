...
- **Joyent, Inc. and other Node contributors**. Copyright holder.  
  libuv library
...
Source:
[`DESCRIPTION`](https://github.com/r-lib/fs/blob/v1.6.7/DESCRIPTION)

Hester J, Wickham H, Csárdi G (2026). *fs: Cross-Platform File System
Operations Based on 'libuv'*. R package version 1.6.7,
<https://fs.r-lib.org>.
