...
- path:
  ...
  The input path, as a
  [`fs_path()`](https://fs.r-lib.org/dev/reference/fs_path.md) character
  vector.
...
- size:
  ...
  The file size, as a
  [`fs_bytes()`](https://fs.r-lib.org/dev/reference/fs_bytes.md) numeric
  vector.

- permissions:

  The file permissions, as a
  [`fs_perms()`](https://fs.r-lib.org/dev/reference/fs_perms.md) integer
  vector.
...
[`dir_info()`](https://fs.r-lib.org/dev/reference/dir_ls.md) to display
file information for files in a given directory.
...
#> 1 mtcars.csv file     1.74K rw-r--r--   2026-03-05 13:03:57 runn… runn…
