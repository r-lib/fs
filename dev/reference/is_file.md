...
[`dir_exists()`](https://fs.r-lib.org/dev/reference/file_access.md) and
[`link_exists()`](https://fs.r-lib.org/dev/reference/file_access.md) if
you want to ensure that the path also exists.
