...
| [`file_touch()`](https://fs.r-lib.org/dev/reference/file_touch.md) | *No direct equivalent*                                 | `touch path`                      |
| [`file_temp()`](https://fs.r-lib.org/dev/reference/file_temp.md)   | [`tempfile()`](https://rdrr.io/r/base/tempfile.html)   | `mktemp`                          |
...
| [`path_temp()`](https://fs.r-lib.org/dev/reference/file_temp.md), `path_temp("path")` | [`tempdir()`](https://rdrr.io/r/base/tempfile.html), `file.path(tempdir(), "path")` | `mktemp -d`                   |
...
| [`path_home()`](https://fs.r-lib.org/dev/reference/path_expand.md)                    | `path.expand("~")`                                                                  | `$HOME`                       |
