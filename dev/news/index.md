...
- New
  [`path_select_components()`](https://fs.r-lib.org/dev/reference/path_select_components.md)
...
- [`dir_exists()`](https://fs.r-lib.org/dev/reference/file_access.md)
...
- [`path_ext()`](https://fs.r-lib.org/dev/reference/path_file.md) and
  [`path_ext_remove()`](https://fs.r-lib.org/dev/reference/path_file.md)
...
- [`path_rel()`](https://fs.r-lib.org/dev/reference/path_math.md)
  provides an informative error message when multiple starting directory
  paths are specified
  ([@IndrajeetPatil](https://github.com/IndrajeetPatil),
...
- [`path_ext_set()`](https://fs.r-lib.org/dev/reference/path_file.md)
  can now handle extensions that contain a `.`, e.g. `csv.gz`
...
- inputs to
  [`path_real()`](https://fs.r-lib.org/dev/reference/path_math.md) and
  [`path_join()`](https://fs.r-lib.org/dev/reference/path_math.md) are
...
- [`file_create()`](https://fs.r-lib.org/dev/reference/create.md) and
  [`dir_create()`](https://fs.r-lib.org/dev/reference/create.md) now
  return the correct path when `...` arguments are used
...
- [`file_exists()`](https://fs.r-lib.org/dev/reference/file_access.md)
  now expands `~` again
  ([\#325](https://github.com/r-lib/fs/issues/325)).

- [`dir_copy()`](https://fs.r-lib.org/dev/reference/copy.md) works when
  `path` has length \>1
...
- [`file_exists()`](https://fs.r-lib.org/dev/reference/file_access.md)
  is now much faster ([\#295](https://github.com/r-lib/fs/issues/295))
...
- [`path_tidy()`](https://fs.r-lib.org/dev/reference/path_tidy.md) now
  works with non-UTF8 encoded paths
...
- `file_info(..., follow = TRUE)`,
  [`is_dir()`](https://fs.r-lib.org/dev/reference/is_file.md), and
  [`is_file()`](https://fs.r-lib.org/dev/reference/is_file.md) follow
  relative symlinks in non-current directories
  ([@heavywatal](https://github.com/heavywatal),
  [\#280](https://github.com/r-lib/fs/issues/280))

- [`dir_map()`](https://fs.r-lib.org/dev/reference/dir_ls.md) now grows
  its internal list safely, the 1.4.0 release introduced an unsafe
  regression ([\#268](https://github.com/r-lib/fs/issues/268))

- [`file_info()`](https://fs.r-lib.org/dev/reference/file_info.md)
  returns a tibble if the tibble package is installed, and subsets work
  when it is a `data.frame`
  ([\#265](https://github.com/r-lib/fs/issues/265))

- [`path_real()`](https://fs.r-lib.org/dev/reference/path_math.md)
  always fails if the file does not exist. Thus it can no longer be used
  to resolve symlinks further up the path hierarchy for files that do
  not yet exist. This reverts the feature introduced in 1.2.7
...
- [`path_has_parent()`](https://fs.r-lib.org/dev/reference/path_math.md)
  now recycles both the `path` and `parent` arguments
  ([\#253](https://github.com/r-lib/fs/issues/253)).

- [`path_ext_set()`](https://fs.r-lib.org/dev/reference/path_file.md)
  now recycles both the `path` and `ext` arguments
...
- [`dir_create()`](https://fs.r-lib.org/dev/reference/create.md) now
  works with absolute paths and `recurse = FALSE`
  ([\#204](https://github.com/r-lib/fs/issues/204)).

- [`dir_tree()`](https://fs.r-lib.org/dev/reference/dir_tree.md) now
  works with paths that need tilde expansion
  ([@dmurdoch](https://github.com/dmurdoch),
  [@jennybc](https://github.com/jennybc),
  [\#203](https://github.com/r-lib/fs/issues/203)).

- [`file_info()`](https://fs.r-lib.org/dev/reference/file_info.md) now
...
- [`is_dir()`](https://fs.r-lib.org/dev/reference/is_file.md),
  [`is_file()`](https://fs.r-lib.org/dev/reference/is_file.md),
  [`is_file_empty()`](https://fs.r-lib.org/dev/reference/is_file.md) and
  [`file_info()`](https://fs.r-lib.org/dev/reference/file_info.md) gain
  a `follow` argument, to follow links and return information about the
  linked file rather than the link itself
  ([\#198](https://github.com/r-lib/fs/issues/198))

- [`path()`](https://fs.r-lib.org/dev/reference/path.md) now follows
  “tidy” recycling rules, namely only consistent or length 1 inputs are
  recycled. ([\#238](https://github.com/r-lib/fs/issues/238))

- [`path()`](https://fs.r-lib.org/dev/reference/path.md) now errors if
  the path given or constructed will exceed `PATH_MAX`
  ([\#233](https://github.com/r-lib/fs/issues/233)).

- [`path_ext_set()`](https://fs.r-lib.org/dev/reference/path_file.md)
  now works with multiple paths
...
- [`dir_ls()`](https://fs.r-lib.org/dev/reference/dir_ls.md),
  [`dir_map()`](https://fs.r-lib.org/dev/reference/dir_ls.md),
  [`dir_walk()`](https://fs.r-lib.org/dev/reference/dir_ls.md),
  [`dir_info()`](https://fs.r-lib.org/dev/reference/dir_ls.md) and
  [`dir_tree()`](https://fs.r-lib.org/dev/reference/dir_tree.md) gain a
...
- [`dir_copy()`](https://fs.r-lib.org/dev/reference/copy.md) gains a
...
- [`dir_create()`](https://fs.r-lib.org/dev/reference/create.md) now
  throws a more accurate error message when you try to create a
  directory in a non-writeable location
...
- [`path_file()`](https://fs.r-lib.org/dev/reference/path_file.md),
  [`path_dir()`](https://fs.r-lib.org/dev/reference/path_file.md) and
  [`path_ext()`](https://fs.r-lib.org/dev/reference/path_file.md) now
  return normal character vectors rather than tidy paths
  ([\#194](https://github.com/r-lib/fs/issues/194)).

- [`path_package()`](https://fs.r-lib.org/dev/reference/path_package.md)
...
- [`file_size()`](https://fs.r-lib.org/dev/reference/file_info.md)
  function added as a helper for `file_info("file")$size`
  ([\#171](https://github.com/r-lib/fs/issues/171))

- [`is_file_empty()`](https://fs.r-lib.org/dev/reference/is_file.md)
  function added to test for empty files\`
  ([\#171](https://github.com/r-lib/fs/issues/171))

- [`dir_tree()`](https://fs.r-lib.org/dev/reference/dir_tree.md)
  function added to print a command line representation of a directory
  tree, analogous to the unix `tree` program
...
- [`path_ext_set()`](https://fs.r-lib.org/dev/reference/path_file.md)
  and [`file_temp()`](https://fs.r-lib.org/dev/reference/file_temp.md)
  now treat extensions with a leading `.` and those without equally.
...
- [`path_ext()`](https://fs.r-lib.org/dev/reference/path_file.md),
  [`path_ext_remove()`](https://fs.r-lib.org/dev/reference/path_file.md),
  and
  [`path_ext_set()`](https://fs.r-lib.org/dev/reference/path_file.md)
  now work on paths with no extension, and
  [`file_temp()`](https://fs.r-lib.org/dev/reference/file_temp.md) now
...
- [`file_chown()`](https://fs.r-lib.org/dev/reference/file_chown.md) can
  now take a `group_id` parameter as character
  ([@cderv](https://github.com/cderv),
  [\#162](https://github.com/r-lib/fs/issues/162)).

- Parameter `browser` in
  [`file_show()`](https://fs.r-lib.org/dev/reference/file_show.md) now
  works as described in the documentation
  ([@GegznaV](https://github.com/GegznaV),
  [\#154](https://github.com/r-lib/fs/issues/154)).

- [`path_real()`](https://fs.r-lib.org/dev/reference/path_math.md) now
  works even if the file does not exist, but there are symlinks further
...
- [`file_move()`](https://fs.r-lib.org/dev/reference/file_move.md) now
  fall back to copying, then removing files when moving files between
  devices (which would otherwise fail)
...
- New [`path_wd()`](https://fs.r-lib.org/dev/reference/path.md)
  generates paths from the current working directory
...
- New [`file_touch()`](https://fs.r-lib.org/dev/reference/file_touch.md)
...
- [`dir_ls()`](https://fs.r-lib.org/dev/reference/dir_ls.md),
  ...
  [`dir_info()`](https://fs.r-lib.org/dev/reference/dir_ls.md) and
  [`file_info()`](https://fs.r-lib.org/dev/reference/file_info.md) gain
  a `fail` parameter, to signal warnings rather than errors if they are
...
- [`path_ext()`](https://fs.r-lib.org/dev/reference/path_file.md),
  ...
  and
  [`path_ext_remove()`](https://fs.r-lib.org/dev/reference/path_file.md)
  now handle paths with non-ASCII characters
...
- [`file_create()`](https://fs.r-lib.org/dev/reference/create.md) and
  [`dir_create()`](https://fs.r-lib.org/dev/reference/create.md) now
  take `...`, which is passed to
  [`path()`](https://fs.r-lib.org/dev/reference/path.md) to make
...
- [`path_ext()`](https://fs.r-lib.org/dev/reference/path_file.md),
  ...
  and
  [`path_ext_remove()`](https://fs.r-lib.org/dev/reference/path_file.md)
  now handle paths with directories including hidden files without
  extensions ([\#92](https://github.com/r-lib/fs/issues/92)).

- [`file_copy()`](https://fs.r-lib.org/dev/reference/copy.md) now copies
...
- [`path_abs()`](https://fs.r-lib.org/dev/reference/path_math.md) gains
  a `start` argument, to specify where the absolute path should be
...
- [`path_expand()`](https://fs.r-lib.org/dev/reference/path_expand.md)
  and [`path_home()`](https://fs.r-lib.org/dev/reference/path_expand.md)
  now use `USERPROFILE` or `HOMEDRIVE`/`HOMEPATH` as the user home
  directory on Windows. This differs from the definition used in
  ...
  are functions
  [`path_expand_r()`](https://fs.r-lib.org/dev/reference/path_expand.md)
  and
  [`path_home_r()`](https://fs.r-lib.org/dev/reference/path_expand.md).
...
- Fix propagation of NA values in
  [`path_norm()`](https://fs.r-lib.org/dev/reference/path_math.md)
  ([\#63](https://github.com/r-lib/fs/issues/63)).

### Features

- [`file_chmod()`](https://fs.r-lib.org/dev/reference/file_chmod.md) is
  now vectorized over both of its arguments
  ([\#71](https://github.com/r-lib/fs/issues/71)).
- [`link_create()`](https://fs.r-lib.org/dev/reference/create.md) now
  fails silently if an identical link already exists
...
- [`path()`](https://fs.r-lib.org/dev/reference/path.md) now returns 0
...
- [`dir_delete()`](https://fs.r-lib.org/dev/reference/delete.md) now
...
- [`link_path()`](https://fs.r-lib.org/dev/reference/link_path.md) now
...
- [`dir_copy()`](https://fs.r-lib.org/dev/reference/copy.md) now copies
  the directory inside the target if the target is a directory
  ([\#51](https://github.com/r-lib/fs/issues/51)).

- [`dir_copy()`](https://fs.r-lib.org/dev/reference/copy.md) now works
