...
- On Linux it is now recommended to build against your system version of
  libuv. The envvar USE_BUNDLED_LIBUV can be used to build a static
  version instead.

- Vendored version of libuv was updated to 1.52.0. This version now
